        ...
        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="text-[#000F67] transition hover:text-[#000F67]/75"
            >
            ...
            <li>
              ...
              >
                ...
                <span className="relative flex size-2">
                  <span
                    className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#000F67] opacity-75"
                  ></span>
                  <span className="relative inline-flex size-2 rounded-full bg-[#000F67]"></span>
                </span>
              </a>
            </li>
          </ul>
    ...
    <div className="mt-12 border-t border-gray-100 pt-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        <p className="text-sm text-gray-500">
          ...
          <a
            className="inline-block text-[#000F67] underline transition hover:text-[#000F67]/75"
            href="#"
          >
            Terms & Conditions
          </a>
